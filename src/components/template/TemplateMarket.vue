<template>
<!--  用来选择模板的来源（自己/市场）-->
  <div class="select sq-right-top is-rounded is-primary">
    <select>
      <option>我的模板</option>
      <option>市场模板</option>
    </select>
  ...
  <div style="position: absolute;top: 10%;width: 100%;height: 85%;overflow-y: scroll">
    <div v-for="i in 10" :key="i" class="columns"
